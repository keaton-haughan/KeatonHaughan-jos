...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	// both request and response is stored in shared page, addr ipc
	// look for open file with req_fileid, if no open file found return error
	// if open file found, read file (file_read) using Openfile*, update offset in Openfile*
	// return number of bytes read (size of file, read size)
	struct OpenFile *o;
    int r;
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	// LAB 5: Your code here.
	// both request and response is stored in shared page addr ipc
	// lookup for open file with req_fileid, if no open file found return error
	// if open file found, write file (file_write) using Openfile*
	// update offset in Openfile*
	// return number of bytes written (size of file, read size)
	struct OpenFile *o;
    int r;
